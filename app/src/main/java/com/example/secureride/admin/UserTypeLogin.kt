...
class UserTypeLogin : AppCompatActivity() {
    ...
    private fun setupButtonClickListeners() {
        binding.registerAs.setOnClickListener {
            Log.d("UserTypeLogin", "Register As button clicked")
            startActivity(Intent(this@UserTypeLogin, RegisterAs::class.java))
        }

        binding.btnLogin.setOnClickListener {
            Log.d("UserTypeLogin", "Login button clicked")
            ...
            .addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    if (snapshot.hasChild(firebaseAuth.currentUser!!.uid)) {
                        ...
                        logged(this@UserTypeLogin.userType)
                    } else {
                        Log.d(TAG, "firebaseAuthWithGoogle: User not Registered")
                        binding.progressBar.visibility = View.GONE
                        Toast.makeText(this@UserTypeLogin, "User not registered", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
